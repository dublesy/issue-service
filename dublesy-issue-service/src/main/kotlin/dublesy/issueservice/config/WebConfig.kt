package dublesy.issueservice.config

import com.fasterxml.jackson.annotation.JsonProperty
import dublesy.issueservice.exception.UnauthorizedException
...
class WebConfig(
    ...
    override fun addResourceHandlers(registry: ResourceHandlerRegistry) {
        val addResourceLocations = registry.addResourceHandler("/**")
    ...
    override fun resolveArgument(
        ...
        return runBlocking {
            WebClient.create()
                .get()
                .uri(authUrl)
                .header("Authorization", authHeader) // Bearer alskdfjklajsdfasdfkajsklfdjlk.aslkdfjalkdsjflaksjdf.aklsdfjklasdjf
                .retrieve()
                .awaitBody<AuthUser>()
        }
//        return AuthUser(
